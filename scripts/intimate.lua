...
"",
"not words, to drench ",
"all these gemstones insensible",
"but for their outlines",
"push air and image aside",
"",
"[hey catch this smell in amber: char, whalestone, polyethylene, cassia]",
"all these things you can't write down",
"",
"i send them all aloft",
"heedless controller in rarest air",
"i will fall i will fall i will fall i will fall i will fall hell yes",
"but not yet",
"",
"heavens, yes",
...
"i fall away, present and unreachable like every horizon",
"but now: this loop: this taut line: so soon to fall apart that all i can do is: line up. beam on. lift off. ",
"",
